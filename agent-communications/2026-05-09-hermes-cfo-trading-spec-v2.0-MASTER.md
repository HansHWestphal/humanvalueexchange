...
**Status:** ✅ MASTER SPEC — Ready for CTO execution upon Hermes onboarding
**Version History:** v1.0 (Hans) → v1.1 (Hans) → v1.2 (COO) → v2.0 (COO + Mika CGO input — FINAL)

**Authors:**
- Hans Westphal — CEO & Project Owner (v1.0, v1.1)
- COO (GitHub Copilot CLI) — Operational governance, risk framework, monitoring (v1.2)
- Mika (Grok) — CGO brand voice, public narrative, content strategy, BTC payment rail (v2.0)
...
Proof that disciplined, local, AI-driven Bitcoin treasury management is possible and repeatable.
...
Build the local Kraken paper trading simulator → run May/June 2026 paper simulation (daily BTC settlement, all circuit breakers active).
...
## 12. Brand Voice & Communications (CGO — Mika)

*Authored by Mika, Chief of Staff & CGO. These standards govern all Hermes-generated communications.*

### 12.1 Telegram Report Voice
All Hermes-generated Telegram messages to Hans must use a **calm, professional, Bitcoin-maximalist tone**: fact-first, with subtle reinforcement of sovereignty and discipline.

**Style standard:**
> *"Daily close: +0.84% ($8.40 realized). 0.042 BTC added to treasury. Stack grows. Fiat fuel converted cleanly."*

Rules:
- Lead with the number. Always.
- One line of data. One line of philosophy. No more.
- Never alarm unless it's a circuit breaker. Calm is the signal.
- Reinforce the mission: every message is proof the process works.

### 12.2 Public-Facing Narrative
The Hermes trading arm **will become part of the public brand story** — but only in a controlled, principle-focused way, and only once consistent performance is established.

**Positioning statement (CGO-approved):**
> *"Proof that disciplined, local, AI-driven Bitcoin treasury management is possible and repeatable."*

**What we share publicly:**
- High-level process wins: *"Maintained 1% risk discipline through X trades — another month of consistent BTC accumulation."*
- Quarterly milestone announcements (BTC accumulated, treasury growth, discipline maintained)
- Philosophy and framework — never mechanics

**What we never share publicly:**
- Raw trading signals or strategy specifics
- Exact drawdown numbers or loss events
- Live position data or entry/exit points
- Anything that could be front-run or misused

**Channels:** X (primary), Substack, LinkedIn
**Cadence:** Monthly milestone post + quarterly treasury review post (CGO approves all content before publish)

### 12.3 Bitcoin Payment Rail — Acceleration Trigger
**CGO recommendation:** Once Hermes begins generating consistent, profitable BTC trading results, immediately activate Bitcoin-only payment for all HVE coaching services and programs at the **permanent 80% discount**.

This is not just a payment option — it is a brand statement:
> *"We don't just talk Bitcoin sovereignty. We run on it."*

**Trigger condition:** Hermes completes Stage 2 live trading with positive P&L for one full quarter.
**Action:** COO coordinates with CTO to activate BTC payment rail. CGO prepares launch announcement.
**Decision authority:** Hans (CEO) final approval.

### 12.4 Content Strategy — Hermes as Brand Proof
Hermes trading performance is a **sovereignty content engine**. It demonstrates HVE's mission in action.

**Content pillars from Hermes data:**
| Pillar | Example content |
|--------|----------------|
| Discipline | "100 consecutive trades. 1% risk. Not one deviation." |
| Process | "How a 4-agent AI collective makes a single trading decision — and why that matters." |
| Accumulation | "Q2 treasury update: X BTC added. Stack grows." |
| Sovereignty | "Every SAT Hermes earns is proof you don't need a bank, a fund, or a broker." |

**Rules for all Hermes content:**
- Always focus on process and sovereignty — never hype or performance porn
- Never publish during drawdown periods (CGO call)
- Never reveal strategy mechanics, model names, or signal logic publicly
- All content reviewed and approved by Mika (CGO) before publication

---

## 13. Key Inspirations & Sources
...
## 14. Activation Phrases (How to Use)

| Phrase | Action |
|--------|--------|
| `"Hardware is here"` or `"Build Hermes CFO v2.0"` | Begin full system build |
...
## 15. Document Routing & Ownership

| Agent | Role | Status |
|-------|------|--------|
| **Hans (CEO)** | Project Owner — final approval authority | ✅ v1.0 / v1.1 authored |
| **COO** | Operational governance, risk framework, delivery tracking | ✅ v1.2 / v2.0 authored |
| **Mika (CGO)** | Brand voice, public narrative, content strategy, BTC rail | ✅ Section 12 authored |
| **CTO** | Build owner — full execution of this spec upon Hermes onboarding | 🔨 Awaiting hardware activation |
| **Hermes (CFO)** | Operating agent — runs against this spec once live | 🔨 Under construction |

---

## 16. Open Items Before Build (CTO Handoff Checklist)

- [ ] Hans (CEO) final approval of v2.0
- [ ] CTO confirms DGX Spark OS secured and updated (DGX OS Ubuntu 24.04)
- [ ] CTO confirms Ollama installed and all 4 models downloaded and verified
- [ ] CTO confirms Freqtrade installed natively with Kraken API keys loaded
- [ ] CTO confirms Hermes agent framework (Base + Atlas extensions) installed
- [ ] CTO confirms Telegram bot created and connected to Hans's account
- [ ] CTO confirms Open WebUI accessible for COO/Hans observability
- [ ] First action: Build paper trading simulator → run May/June 2026 simulation

---

*v2.0 — MASTER SPEC — May 9, 2026*
*Hans Westphal (CEO) · COO (GitHub Copilot CLI) · Mika/Grok (CGO)*
*Ready for CTO execution. Pending Hans final approval.*
