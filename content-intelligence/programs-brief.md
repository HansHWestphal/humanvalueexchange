...
**Platform:** Substack (primary) + Square.site (commerce)
...
**Platform:** Square.site (booking) + Teams/Zoom (delivery)

---

### 4. 1:1 Life Hacking Consultation
| | |
|--|--|
| **Price** | Custom (inquire) |
| **Status** | Available Now |

**Description:** Custom one-on-one sessions focused on mindfulness, meditation, Transurfing Reality, AI productivity, and personal sovereignty.

**Platform:** Square.site (inquiry/booking)

---

### 5. 1:1 Bitcoin & Infinite Banking Coaching
| | |
|--|--|
| **Price** | Custom (inquire) |
| **Status** | Available Now |

**Description:** Personalized guidance on Bitcoin as the primary measure of human value and Infinite Banking strategies for true financial sovereignty.

**Platform:** Square.site (inquiry/booking) | bitcoincoach.ca (potential dedicated landing page)

---

### 6. Fitness & Energy Mastery Coaching *(with Wolfgang)*
| | |
|--|--|
| **Price** | Custom (inquire) |
| **Status** | Available Now |
